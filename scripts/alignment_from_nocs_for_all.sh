...
python scripts/alignment_from_nocs.py --category 04256520 --prediction_path output/nocs/04256520 --pose_gt_root datasets/Scan2CAD/val_pose_gt/scan2cad_val_04256520.json --mesh_root /project/3dlg-hcvc/diorama/diffcad/object_meshes/04256520 --split_path splits/pose/04256520/val_nonocc_centroid_maskexist.txt --outdir output/pose --num_iters 5

python scripts/alignment_from_nocs.py --category 04379243 --prediction_path output/nocs/04379243 --pose_gt_root datasets/Scan2CAD/val_pose_gt/scan2cad_val_04379243.json --mesh_root /project/3dlg-hcvc/diorama/diffcad/object_meshes/04379243 --split_path splits/pose/04379243/val_nonocc_centroid_maskexist.txt --outdir output/pose --num_iters 5
